 ...
 *              支持驱动IC型号包括:ILI9341/NT35310/NT35510/SSD1963/ST7789/ST7796 等
 *
...
void lcd_display_on(void)
{
    ...
    else    /* 9341/5310/1963/7789/7796 等发送开启显示指令 */
    {
...
void lcd_display_off(void)
{
    ...
    else    /* 9341/5310/1963/7789/7796 等发送关闭显示指令 */
    {
...
void lcd_set_window(uint16_t sx, uint16_t sy, uint16_t width, uint16_t height)
{
    ...
    else    /* 9341/5310/7789/1963/7796横屏 等 设置窗口 */
    {
        lcd_wr_regno(lcddev.setxcmd);
        lcd_wr_data(sx >> 8);
        lcd_wr_data(sx & 0XFF);
