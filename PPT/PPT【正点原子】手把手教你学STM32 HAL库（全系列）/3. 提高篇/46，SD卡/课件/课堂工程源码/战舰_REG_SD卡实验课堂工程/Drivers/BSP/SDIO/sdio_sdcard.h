...
/* SDIO相关参数定义 */
#define NULL 0
#define SDIO_STATIC_FLAGS                          ((uint32_t)0x000205FF)
#define SDIO_CMD0TIMEOUT                           ((uint32_t)0x00010000)
#define SDIO_CMD1TIMEOUT                           ((uint32_t)0x00FFFFFF)
#define SDIO_DATATIMEOUT                           ((uint32_t)0X00FFFFFF)
...
static SD_Error sdio_wide_bus_operation(uint32_t bwide);
